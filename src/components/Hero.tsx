    ...
    <div className='h-screen max-h-[800px] flex items-center justify-between sm:flex-col lg:flex-row'>
        <div className='w-full lg:w-[40%] px-4 lg:px-0 h-full sm:h-[50%] sm:mt-36 flex flex-col justify-end lg:justify-center gap-4 pb-8 lg:pb-0'>
            ...
            <div className='flex gap-4 sm:justify-center lg:justify-start'>
                <Link to={"/"} className='py-1 pl-4 pr-1 rounded-full bg-[#FFDD66] flex items-center gap-4'>Get Started <div className="w-10 h-10 rounded-full flex items-center justify-center bg-white"><span className='text-xl'>&#x27F6;</span></div></Link>
                <Link to={"/"} className='py-3 px-8 rounded-full bg-black text-white'>Buy</Link>
            </div>
        </div>
